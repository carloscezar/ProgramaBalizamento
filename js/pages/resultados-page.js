                ...
                provaCard.innerHTML = `
                    <div class="prova-header">
                        ...
                        <div class="prova-stats">
                            ...
                            ${!resultado?.finalizada ? `<button class="btn btn-warning" style="margin-left: 0.5rem;">⏹️ Finalizar</button>` : ''}
                            ${resultado?.finalizada ? `
                                <button class="btn btn-info" style="margin-left: 0.5rem; padding: 0.3rem 0.9rem; font-size: 0.9rem;">📄 HTML</button>
                                <button class="btn btn-success" style="margin-left: 0.3rem; padding: 0.3rem 0.9rem; font-size: 0.9rem;">📊 Excel</button>
                            ` : ''}
                        </div>
                    </div>
